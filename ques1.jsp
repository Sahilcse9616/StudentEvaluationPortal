...
while(rs.next())
{
    ...
    %>
    <form action="ques01.jsp" method="post">
    <h2>
<feildset>
<br><%=q %><br>
  <input type="radio" name="ques1" value="<%=op1%>"> <%=op1%><br>
  <input type="radio" name="ques1" value="<%=op2%>"> <%=op2%><br>
  <input type="radio" name="ques1" value="<%=op3%>"> <%=op3%><br>
  <input type="radio" name="ques1" value="<%=op4%>"> <%=op4%><br>
