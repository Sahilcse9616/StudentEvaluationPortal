...
while(rs.next())
{
	if((rs.getString("quesid")).equals("ques20"))
	{
...
<feildset>
<br><%=q %><br>
  <input type="radio" name="ques20" value="<%=op1%>"> <%=op1%><br>
  <input type="radio" name="ques20" value="<%=op2%>"> <%=op2%><br>
  <input type="radio" name="ques20" value="<%=op3%>"> <%=op3%><br>
  <input type="radio" name="ques20" value="<%=op4%>"> <%=op4%><br>
