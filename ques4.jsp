...
while(rs.next())
{
	if((rs.getString("quesid")).equals("ques4"))
	{
    ...
    %>
    <form action="ques04.jsp" method="post">
    <h2>
<feildset>
<br><%=q %><br>
  <input type="radio" name="ques4" value="<%=op1%>"> <%=op1%><br>
  <input type="radio" name="ques4" value="<%=op2%>"> <%=op2%><br>
  <input type="radio" name="ques4" value="<%=op3%>"> <%=op3%><br>
  <input type="radio" name="ques4" value="<%=op4%>"> <%=op4%><br>
