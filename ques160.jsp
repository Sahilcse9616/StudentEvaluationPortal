...
while(rs.next())
{
	if((rs.getString("quesid")).equals("ques16"))
	{
...
<feildset>
<br><%=q %><br>
  <input type="radio" name="ques16" value="<%=op1%>"> <%=op1%><br>
  <input type="radio" name="ques16" value="<%=op2%>"> <%=op2%><br>
  <input type="radio" name="ques16" value="<%=op3%>"> <%=op3%><br>
  <input type="radio" name="ques16" value="<%=op4%>"> <%=op4%><br>
