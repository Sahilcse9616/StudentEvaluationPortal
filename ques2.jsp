...
while(rs.next())
{
	if((rs.getString("quesid")).equals("ques2"))
	{
    ...
    %>
    <form action="ques02.jsp" method="post">
    <h2>
<br><%=q %><br>
  <input type="radio" name="ques2" value="<%=op1%>"> <%=op1%><br>
  <input type="radio" name="ques2" value="<%=op2%>"> <%=op2%><br>
  <input type="radio" name="ques2" value="<%=op3%>"> <%=op3%><br>
  <input type="radio" name="ques2" value="<%=op4%>"> <%=op4%><br>
